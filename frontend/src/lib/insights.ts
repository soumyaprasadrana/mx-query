...
export const INSIGHTS: Insight[] = [
  ...
  { id: "csv", doodle: "sign", title: "Excel export", body: "The table Excel button writes child collections. Sheets = one tab per relationship. Flat = parent columns repeat on each leaf." },
  { id: "json", doodle: "book", title: "JSON is the tree", body: "JSON is the nested payload as returned. Excel is a workbook you configure on the table. They are not the same document." },
  ...
  { id: "nolimit", doodle: "book", title: "Child limit", body: "Each nested hop sends childOptions.limit (50 by default). Raise it, or set noLimit, when a child set is larger than the cap." },
