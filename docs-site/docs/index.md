...
features:
  ...
  - title: Builder
    details: Object-structure search, parent and child columns, WHERE, nested child-row filters (path hops), sort, execute, results, and import of pasted tool-call JSON or an OSLC GET.
  - title: Saved queries
